...
def generate_story_with_pollinations(topic: str) -> str:
    ...
    system = "You are a historian specializing in ancient women history. Write a short 30-second interesting story (80-130 words) in Korean. Tell real historical facts, laws, customs, or traditions. Use a lively, captivating style. No titles."
    prompt = f"Theme: {topic}. Tell an interesting historical fact in Korean."
    ...
    for attempt in range(3):
        ...
        return f"아주 오래전, 고대 세계에서 여성들은 놀라운 방식으로 법률, 관습, 일상을 형성했습니다. {topic}. 용기와 재능, 회복력에 대한 그들의 이야기는 역사 속에 울려 퍼지며 오늘날에도 우리에게 영감을 줍니다."
...
Style: Default,Noto Sans KR,160,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,1,0,0,0,100,100,0,0,1,6,3,5,10,10,0,1
